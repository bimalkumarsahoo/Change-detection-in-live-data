...
##        print (change)
        ...
        if (i%300 > 210) and (i%300 < 230 + window_size):
            f_change += 1 - change
            val += 1
        elif (i%300 == 230 + window_size):
...
plt.show()
fun = lambda x: x/59
print ("ARL mean", np.mean(icrl[1:]))
print ("ARL rate", np.mean(list(map(fun,icrl[1:]))))
